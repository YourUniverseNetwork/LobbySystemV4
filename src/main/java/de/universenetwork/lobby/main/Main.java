...
import de.universenetwork.lobby.playerhider.VisibleManager;
import de.universenetwork.lobby.utils.MySQL;
import de.universenetwork.lobby.utils.SettingsSystem;
import de.universenetwork.lobby.vanish.VanishManager;
import de.universenetwork.lobby.vanish.vanishCMD;
...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("huhn").setExecutor(new huhnCMD());
        getCommand("coins").setExecutor(new coinCMD());
